                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                          <?php foreach($accounting->result() as $cu):?>
                                            <tr align="center">
                                                ...
                                                <td><a href="<?php echo base_url().'Accounting/view_dokumen/'.$cu->id_po?>"><button class="btn btn-success btn-rounded m-b-10 m-l-5">View</button></a></td>
                                                <td align="center"><?php if($cu->status=='PIC Approval'):?><a href="<?php echo base_url().'Invoice/create/'.$cu->id_po?>"><button class="btn btn-success btn-rounded m-b-10 m-l-5">Create INV</button></a><?php endif?>
                                                  <?php if($cu->status=='Invoicing' or $cu->status=='Print Invoice' or $cu->status=='Paid'):?><a href="<?php echo base_url().'Accounting/view/'.$cu->id_po?>"><button class="btn btn-success btn-rounded m-b-10 m-l-5">View INV</button></a><?php endif?>
                                                </td>
                                            </tr>
                                          <?php endforeach ?>
                                        </tbody>
