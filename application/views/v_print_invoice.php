...
<div style="width: 100%; height: 50px; border-top: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000;">
    <div style="float: left; width: 50%;">
        <h1 style="margin-top: 5px; text-align: center; margin-bottom: 0;">Invoice</h1>
    </div>
...
<table style="width: 100%;" border="1">
  ...
  <tr align="right">
      ...
      <td><?php echo number_format($row['faktur_ppn'])?></td>
  </tr>
  <tr align="right">
      <td colspan="4">Grand Total</td>
      <td><?php echo number_format($row['faktur_ppn'] + $total_harga)?></td>
  </tr>
</table>
<div style="clear: both;"></div>
<div style="width: 50%; float: left;">
    <p><b>Due Date : <?= date('d F Y') ?></b></p>
    <p style="text-decoration: underline; margin-top: 30px; margin-bottom: 0;">Payment Term:</p>
    <p style="margin: 0;"><b>Make payment to :</b></p>
    <p style="margin: 0;"><b>a/n : <?php echo $row['nama_vendor']?></b></p>
    <p style="margin: 0;"><b><?php echo $row['nama_bank']?> a/c : <?php echo $row['no_rekening']?></b></p>
</div>
